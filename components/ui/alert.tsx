...
const AlertTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(({ className, ...props }, ref) => <h5 ref={ref} className={cn("text-h8 font-display uppercase font-normal text-almostblack mb-1 leading-none tracking-tight", className)} {...props} />);
