...
export function TracklistToggle({ tracklist }: { tracklist: string }) {
  ...
  return (
    <div className="w-full space-y-4">
      <button
        className="text-m8 md:text-m7 font-mono uppercase bg-almostblack text-white hover:bg-white hover:cursor-pointer hover:border-almostblack hover:text-almostblack border border-1 p-2 px-3"
