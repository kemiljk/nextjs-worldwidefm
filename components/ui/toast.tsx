...
const ToastClose = React.forwardRef<React.ElementRef<typeof ToastPrimitives.Close>, React.ComponentPropsWithoutRef<typeof ToastPrimitives.Close>>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-none p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-black dark:group-[.destructive]:text-white group-[.destructive]:hover:text-black dark:group-[.destructive]:hover:text-white group-[.destructive]:focus:ring-black dark:group-[.destructive]:focus:ring-white group-[.destructive]:focus:ring-offset-black dark:group-[.destructive]:focus:ring-offset-white",
      className
    )}
    toast-close=""
    {...props}
