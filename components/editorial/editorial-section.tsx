...
export default function EditorialSection({
  ...
  articles,
  moods,
  className = 'mb-12 bg-sky-700 p-8 rounded-lg z-10',
  ...
  return (
    <div className={className}>
      <div className='flex items-center justify-between mb-6'>
        ...
        <Link
          href='/editorial'
          className='text-sm text-gray-300 flex items-center hover:text-white transition-colors group'
        >
          View All{' '}
