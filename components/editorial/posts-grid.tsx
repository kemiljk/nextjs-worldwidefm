          ...
          return (
            <Link href={`/editorial/${post.slug}`} key={post.slug} className="group border border-sky-900 dark:border-sky-50 p-4">
              <div className="relative">
                ...
                <div className="mt-2">
                  <div className="text-[12px] leading-none uppercase tracking-wider text-muted-foreground mb-1">{formattedDate}</div>
                  ...
                  <div className="text-[12px] leading-none uppercase tracking-wider text-muted-foreground mt-2">By {typeof post.metadata.author === "string" ? post.metadata.author : post.metadata.author?.title || "Unknown"}</div>
                </div>
              </div>
            </Link>
          );
