  ...
  if (!articles || articles.length === 0) {
    return (
      <div>
        ...
        <div className='bg-brand-blue-light p-4 rounded-lg text-white text-center'>
    ...
    <div>
      ...
      <div className='grid gap-4'>
        {articles.map((article) => (
          ...
          >
            <Card className='overflow-hidden border-none shadow-md bg-brand-blue-light hover:bg-brand-blue-light/90'>
