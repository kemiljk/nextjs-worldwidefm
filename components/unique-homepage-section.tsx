    ...
    <section className='relative w-full overflow-hidden'>
      ...
      <div className='relative z-10 px-5 py-24'>
        ...
        <div className='flex items-center pb-12'>
          {/* Main Title */}
          <h2 className='font-display text-4xl md:text-5xl leading-none uppercase tracking-tight break-words'>
            <HighlightedText variant='default'>{displayTitle}</HighlightedText>
          </h2>

          {/* Subtitle with color background */}
          {displayTime && (
            <h3 className='font-display text-4xl md:text-5xl leading-none uppercase tracking-tight break-words ml-4'>
              <HighlightedText
                variant='custom'
          ...
          {displayDescription && (
            <div className='max-w-2xl ml-12'>
              <p className='font-body text-xl text-almostblack leading-none'>
                {displayDescription}
              </p>
            </div>
          )}
        ...
        <div className='text-center mt-12'>
          <a
            href={`/${section.type}`}
            className='font-mono text-xl text-almostblack uppercase underline hover:no-underline transition-all'
          >
            SEE ALL &gt;
          </a>
        </div>
