...
export function getFormattedDate(
  ...
  if (prefomattedDate) return prefomattedDate + ' at ' + hours + ':' + minutes + am_pm;
  if (hideYear) {
    // 10. January at 10:20
    return day + ', ' + month + ' ' + date_number + ' at ' + hours + ':' + minutes + am_pm;
  }
  // 10. January 2017. at 10:20
  return (
    day + ', ' + month + ' ' + date_number + ', ' + year + ' at ' + hours + ':' + minutes + am_pm
  );
}
