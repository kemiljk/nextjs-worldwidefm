    ...
    <div className="py-8">
      <div className="mx-auto max-w-md">
        <div className="bg-card p-8 shadow-sm">
          <h1 className="font-display text-3xl font-normal tracking-tight text-center mb-8">Reset Your Password</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input type="password" id="confirmPassword" name="confirmPassword" required minLength={8} placeholder="Confirm your new password" />
            </div>
