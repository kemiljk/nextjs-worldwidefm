      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 py-16">
        ...
        <div className="md:col-span-7">
          <div className="border-l-2 border-bronze-500 pl-6">
            <h2 className="text-h7 font-display uppercase font-normal text-almostblack">{about.metadata.connect_title}</h2>
            <div className="prose dark:prose-invert" dangerouslySetInnerHTML={{ __html: about.metadata.connect_content }} />

            <div className="mt-8 space-y-4">
              <div>
                <h3 className="text-m5 font-mono font-normal text-almostblack">Contact</h3>
              ...
              <div>
                <h3 className="text-m5 font-mono font-normal text-almostblack">Social</h3>
        ...
        <div className="md:col-span-5">
          <h2 className="text-h7 font-display uppercase font-normal text-almostblack">{about.metadata.partner_with_us_title}</h2>
          <div className="prose dark:prose-invert" dangerouslySetInnerHTML={{ __html: about.metadata.partner_with_us_description }} />
        </div>
        <div className="md:col-span-7">
          <div className="border-l-2 border-bronze-500 pl-6">
            <h3 className="text-m5 font-mono font-normal text-almostblack mb-4">Partners</h3>
