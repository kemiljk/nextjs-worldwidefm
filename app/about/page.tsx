      ...
      <div className="container mx-auto pt-32 pb-32">
        ...
        <div className="relative h-[50vh] mb-16 rounded-lg overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 p-8 md:p-12 text-white max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Worldwide FM</h1>
        ...
        <div className="mb-20">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-brand-orange mb-6">Our Mission</h2>
            ...
            {[1, 2, 3, 4].map((index) => (
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-brand-orange">Role / Position</p>
                  <p className="text-sm text-muted-foreground mt-2">Brief description about this team member's background and contribution to Worldwide FM.</p>
                </div>
              </div>
            ))}
          </div>
