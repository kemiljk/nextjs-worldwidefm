          ...
          <div className="flex flex-col gap-10">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href={about.metadata.social_links.metadata.instagram} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:underline transition-colors text-sm">
                  Instagram
                </a>
                <a href={about.metadata.social_links.metadata.twitter} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:underline transition-colors text-sm">
                  Twitter
                </a>
                <a href={about.metadata.social_links.metadata.facebook} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:underline transition-colors text-sm">
                  Facebook
                </a>
              </div>
            </div>
