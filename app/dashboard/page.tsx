...
export default async function DashboardPage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <DashboardClient userData={data.userData} allGenres={data.allGenres} allHosts={data.allHosts} allShows={data.allShows} genreShows={data.genreShows} hostShows={data.hostShows} favouriteGenres={data.favouriteGenres} favouriteHosts={data.favouriteHosts} favouriteShows={data.favouriteShows} />
    </div>
  );
}
